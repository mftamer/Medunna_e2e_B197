...
public class DBUtils {
    ...
    //    resultSet: used to perform DB actions such as going to specific rows, get data as string, get data as an object
     ...
     * STATEMENT: is used to write a query
     */
    ...
    /**
     * @return returns query result in a list of lists where an outer list represents
     *         a collection of rows and inner lists represent a single row
     */
     ...
     *         a collection of rows and a map represents a single row with
