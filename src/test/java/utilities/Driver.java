...
/*
NOTE: all of our current codes still works, because this driver is class is good for sequential and parallel testing
 */
public class Driver {
    private Driver(){}
    //    Private static WebDriver driver;
//    1. Use ThreadLocal WebDriver for parallel testing.
//    The Type of the driver is still WebDriver, but this driver is now ThreadLocal
